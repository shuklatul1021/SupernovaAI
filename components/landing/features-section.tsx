...
const features = [
  {
    ...
    description: "AI generates topic-wise MCQ quizzes based on your subject and target exam. It adapts difficulty in real-time to accurately map your strengths and weaknesses.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Study Roadmap",
    description: "Get a personalized day-by-day study plan in seconds. The AI prioritizes weak topics, optimizes for your available time, and adjusts if you fall behind.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Smart Resources",
    description: "Every topic comes with curated free resources — videos, articles, and practice problems — handpicked by AI to match your learning style.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Progress Tracking",
    description: "Track your daily progress, see which topics you've mastered, and watch your weak areas shrink. The AI regenerates your plan as you improve.",
    visual: "security",
  },
];
